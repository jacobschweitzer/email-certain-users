...
if ( ! class_exists( 'Email_Certain_Users' ) ) {
	 ...
	 *
	 * Email_Certain_users is an object-oriented/MVC base for building WordPress plugins
	 */
	class Email_Certain_Users extends ECU_Module {
		...
		public function upgrade( $db_version = 0 ) {
			if ( version_compare( $this->modules['ECU_Settings']->settings['db-version'], self::VERSION, '==' ) ) {
				return;
			}

			foreach ( $this->modules as $module ) {
				$module->upgrade( $this->modules['ECU_Settings']->settings['db-version'] );
			}

			$this->modules['ECU_Settings']->settings = array( 'db-version' => self::VERSION );
